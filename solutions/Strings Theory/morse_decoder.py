#!/home/valentyna-sinichenko/miniconda3/envs/checkio/bin/checkio --domain=py run morse-decoder
...
# 
# Output:The decrypted text(str).
# 
# Preconditions:0 < len(message) < 100;The message will consists of numbers and English letters only.
# 
# 
# END_DESC

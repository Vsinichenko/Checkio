#!/home/valentyna-sinichenko/miniconda3/envs/checkio/bin/checkio --domain=py run hacker-language

# Your friends and you have decided to feel like true hackers and create a special "hacker language" for correspondence in the net. The original messages will be written in English and then encrypted according to these rules:
# - all letters and whitespaces will be converted into theirASCIIcodes and then into the binary numbers. Except the whitespaces - their binary form should be '1000000' not '100000'.
...
# assert message_2.read('10011011111001100000011001011101101110000111010011101100100000011010011110011100000011011011110010.11100101101111110001011011111110100@11001111101101110000111010011101100.110001111011111101101') ==

#!/home/valentyna-sinichenko/miniconda3/envs/checkio/bin/checkio --domain=py run hexagonal-islands
...
# Note:
# 
# The islands don't include other islands.If there is no island (input == set ()), return [].There are also case that  no sea. (In this case your answer is [108].)Input:The coastal hexes of all islands  (a set of strings).
# 
# Output:The sizes of all islands (an iterable ( a list or tuple) of integers).
# 
# How it is used:
# 
# For recognizing the area on the hexagonal grid.Preconditions:all(re.fullmatch('[A-L][1-9]', i) for i in input)
# 
# 
# END_DESC
